...
namespace MM2
{
    ...
    public:
        ...
        */
        ...
        AGE_API virtual phMaterial const * GetMaterial(int a1)
                                                        PURE;
        ...
        AGE_API virtual bool TestProbePoint(phSegment& a1, phIntersectionPoint* a2, float a3) const
                                                        PURE;
        AGE_API virtual bool TestAIPoint(phSegment& a1, phIntersectionPoint* a2) const
                                                        PURE;
        AGE_API virtual int TestEdge(phSegment& a1, phIntersection* a2, int a3) const
                                                        PURE;
        AGE_API virtual bool TestProbe(phSegment& a1, phIntersection* a2, float a3) const
                                                        PURE;
        AGE_API virtual bool TestSphere(Vector3 const& a1, float a2, phImpactBase& a3) const
                                                        { return hook::Thunk<0x4876C0>::Call<bool>(this, &a1, a2, &a3); }
        AGE_API virtual bool TestSphere(Vector3 const& a1, float a2, Vector3& a3, Vector3& a4, float& a5) const
                                                        { return hook::Thunk<0x4876B0>::Call<bool>(this, &a1, a2, &a3, &a4, &a5); }
        AGE_API virtual void ModifyInvMassMatrix(Matrix34* a1, int a2, Vector3 const& a3, Vector3 const& a4) const
                                                        { hook::Thunk<0x45CF90>::Call<void>(this, a1, a2, &a3, &a4); }
        AGE_API virtual void ModifyInvMassMatrix(Matrix34* a1, int a2, Vector3 const& a3) const
                                                        { hook::Thunk<0x45CF80>::Call<void>(this, a1, a2, &a3); }
        AGE_API virtual float EffectiveMass(Vector3 const& a1, Vector3 const& a2, int a3, float a4) const
