...
namespace MM2
{
    ...
    public:
        AGE_API vehAero() { ageHook::Thunk<0x4D9320>::Call<void>(this); }

        /*
            asNode virtuals
        */

        AGE_API void Update() override                  { ageHook::Thunk<0x4D9360>::Call<void>(this); }
        AGE_API void FileIO(datParser& parser) override { ageHook::Thunk<0x4D96E0>::Call<void>(this); }
        AGE_API char* GetClassName() override           { return ageHook::Thunk<0x4D9790>::Call<char*>(this); }
