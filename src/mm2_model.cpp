...
modStatic * modGetStatic(LPCSTR file, float &a2, bool a3) {
    return ageHook::StaticThunk<0x4A52E0>::Call<modStatic *>(file, &a2, a3);
}

modStatic * modGetStatic(LPCSTR file, void(*a2)(Vector3 &, void *), void *a3, bool a4) {
    return ageHook::StaticThunk<0x4A4E30>::Call<modStatic *>(file, a2, a3, a4);
}

modModel * modGetModel(LPCSTR filename, uint a2, bool a3, bool a4) {
    return ageHook::StaticThunk<0x597A70>::Call<modModel *>(filename, a2, a3, a4);
}
