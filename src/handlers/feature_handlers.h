...
public:
    ...
    static LRESULT APIENTRY gfxPipelineHandler::gfxWindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
class vglHandler {
private:
    static unsigned int GetAdjustedColor(MM2::gfxDrawMode drawMode, unsigned int color);
public:
