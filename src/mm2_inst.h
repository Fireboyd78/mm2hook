...
namespace MM2
{
    ...
    namespace $
    {
		...
		{
			HOOK_API AGEHook<0x0057B580>::MemberFunc<MM2::aiPedestrianInstance*> $$ctor;
	...
	class lvlInstance {
	public:
		AGE_API virtual void Init(char* name, Matrix34 const &matrix, int unknown) {
	...
	public:
		...
		AGE_API static dgUnhitBangerInstance* RequestBanger(char* name, bool unknown) {
