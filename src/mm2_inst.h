...
namespace MM2
{
    ...
    namespace $
    {
        ...
        {
            declhook(0x0057B780, _MemberFunc<bool>, IsCollidable);
            declhook(0x0057B730, _MemberFunc<MM2::dgPhysEntity *>, AttachEntity);
        }
    }
    ...
    public:
        ...
        virtual AGE_API int IsVisible(gfxViewport const * a1) { return ageHook::Thunk<0x4649F0>::Call<int>(this, a1); }

        virtual AGE_API Matrix34 const & GetMatrix(class Matrix34 &) PURE;
        virtual AGE_API void SetMatrix(class Matrix34 const &) PURE;
        ...
        virtual AGE_API int Init(char const * a1, Matrix34 const & a2, int a3) {return ageHook::Thunk<0x463D90>::Call<int>(this, a1, a2, a3); }
        ...
        virtual AGE_API void GetLightInfo(int a1, cltLight * a2) { ageHook::Thunk<0x4630B0>::Call<void>(this); }
        virtual AGE_API int SetupGfxLights(Matrix34 const & a1) { return ageHook::Thunk<0x464670>::Call<int>(this, a1); }
        virtual AGE_API phBound const * GetBound(int a1) { return ageHook::Thunk<0x4648C0>::Call<phBound const*>(this, a1); };

        //lvlInstance non virtuals
        ...
        static AGE_API void SetShadowBillboardMtx(Matrix44 & a1) { ageHook::StaticThunk<0x463290>::Call<void>(a1); }

    protected:
        static AGE_API int GetGeomSet(char const * a1, char const * a2, int a3) { return ageHook::StaticThunk<0x4632C0>::Call<int>(a1, a2, a3); }
    ...
    public:
        ...
        AGE_API bool BeginGeom(char const * a1, char const * a2, int a3) { return ageHook::Thunk<0x463A80>::Call<bool>(this, a1, a2, a3); }
        AGE_API int AddGeom(char const * a1, char const * a2, int a3) { return ageHook::Thunk<0x463BA0>::Call<int>(this, a1, a2, a3); }
        AGE_API void EndGeom() { ageHook::Thunk<0x463BC0>::Call<void>(this); }
        AGE_API static int AddSphere(float a1) { return ageHook::StaticThunk<0x463D50>::Call<int>(a1); }
        ...
        AGE_API bool NeedGhostBound(Vector3 const * a1, int a2) { return ageHook::Thunk<0x4641A0>::Call<bool>(this, a1, a2); }
        AGE_API bool InitGhostBound(phBound * a1, Vector3 const * a2, int a3) { return ageHook::Thunk<0x464200>::Call<bool>(this, a1, a2, a3); }
        AGE_API int InitGhost(char const * a1, Matrix34 const & a2) { return ageHook::Thunk<0x464330>::Call<int>(this, a1, a2); }
